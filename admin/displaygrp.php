...
<body class="bg-light">
  ...
  <div style="position: relative;" class="container my-5">
    ...
    <a href="addgrp.php" style="position: absolute; right: 0; top: 0px;" class="btn btn-primary">Add Group</a>
            ...
            if($result->num_rows > 0){
              while($row = $result->fetch_assoc()){
                echo '<tr>
                        ...
                        <td>'.$row['votes'].'</td>
                        <td>
                          <a class="btn btn-info" href="addgrp.php?id='.$row['id'].'">Update Group</a>
                          <a class="btn btn-danger ms-5" href="helperdelgrp.php?id='.$row['id'].'">Delete Group</a>
                        </td>
                    </tr>';
              } 
            }
